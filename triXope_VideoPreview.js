...
function previewVideo(node,file,type){
    ...
    params.filename = encodeURIComponent(file);
    previewWidget.videoEl.src = `/view?` + new URLSearchParams(params);
...
app.registerExtension({
	name: "triXope.VideoPreview",
	async beforeRegisterNodeDef(nodeType, nodeData, app) {
		if (nodeData?.name == "triXope_VideoPreview") {
